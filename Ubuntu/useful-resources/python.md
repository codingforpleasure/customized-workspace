...
<!-- Added by: gil_diy, at: Sat 01 Jan 2022 12:31:55 IST -->
...
Different names which start and end with the double underscore. They are called as **magic methods**, Built-in classes in Python define many magic methods. Use the `dir()` function to see the number of magic methods inherited by a class. For example, the following lists all the attributes and methods defined in the int class. 
