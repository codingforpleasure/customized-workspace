...
Elasticsearch is a distributed search and analytics engine (you can run complex quieries and aggregation on your search results) which runs on Lucene.
...
**How do i list the indeces in my cluster?**
...
```
**How to check the document existance but do not gives the document content?**
```bash
