<!--ts-->
   * [An OpenCV glimpse](#an-opencv-glimpse)
      ...
      * [Image Stiching](#image-stiching)
         * [Dealing with outliers (RANSAC - Random )](#dealing-with-outliers-ransac---random-)
         * [Homography matrix](#homography-matrix)
      * [Deep learning in OpenCV](#deep-learning-in-opencv)
         * [The function blobFromImage(s)](#the-function-blobfromimages)
            * [1. Mean subtraction](#1-mean-subtraction)

<!-- Added by: gil_diy, at: Tue 22 Feb 2022 15:43:15 IST -->
...
### Dealing with outliers (RANSAC - Random )
